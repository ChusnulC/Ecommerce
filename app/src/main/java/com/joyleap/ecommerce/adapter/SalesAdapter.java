package com.joyleap.ecommerce.adapter;
...
public class SalesAdapter extends SimpleAdapter {
    ...
    public SalesAdapter(Context context, ArrayList<HashMap<String, String>>data, int resorce, String[]from, int[]to){
    ...
    public View getView(int position, View convertView, ViewGroup parent){
        ...
        Picasso.with(context)
                .load("android.resource://com.joyleap.ecommerce/drawable/" + arrayList.get(position).get("product"))
                .resize(300, 300)
                .centerCrop()
                .into(imgProduct);
        ...
        Picasso.with(context)
                .load("android.resource://com.joyleap.ecommerce/mipmap/" + shipment)
                .resize(300, 300)
                .centerCrop()
                .into(imgCar);
        ...
        Picasso.with(context)
                .load("android.resource://com.joyleap.ecommerce/mipmap/" + drop)
                .resize(300, 300)
                .centerCrop()
                .into(imgDrop);
        ...
        Picasso.with(context)
                .load("android.resource://com.joyleap.ecommerce/mipmap/" + finish)
                .resize(300, 300)
                .centerCrop()
                .into(imgFinish);
